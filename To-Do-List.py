...
def add_task():
    ...
    if task:
        ...
        messagebox.showwarning("Warning", "Not possible to create empty task!")
...
def update_frame():
    ...
    for index, task in enumerate(tasks):
        ...
        delete_button = tk.Button(task_frame, bg="red", fg="white", text="Delete", font=("Helevetica", 10), borderwidth=1, command=lambda index=index: delete_task(index))
...
head_frame = tk.Frame(root, bg="blue")
head_frame.pack(pady=10, padx=10, side=tk.TOP, fill="x")
label_heading = tk.Label(head_frame, bg="blue", fg="white",  text="To Do List", font=("Helvetica", 22))
